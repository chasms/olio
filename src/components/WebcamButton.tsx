...
interface DispatchProps {
  toggleWebcamModal: () => void;
}
type Props = StateProps & DispatchProps;
class WebcamButton extends React.Component<Props> {
  render() {
    return (
        ...
        >
          <g>
            <g>
              <g>
                <path
                  d="M259.095,270.913c38.49-26.962,63.711-71.59,63.711-122.042C322.806,66.786,256.032,0,173.923,0
              ...
              <g>
                <path
                  d="M173.923,191.379c23.431,0,42.502-19.068,42.502-42.496c0-23.424-19.071-42.493-42.502-42.493
...
const mapStateToProps = (state: RootState): StateProps => ({ webcamActive: state.Modals.webcam });
const mapDispatchToProps = (dispatch: Dispatch): DispatchProps =>
  bindActionCreators({ toggleWebcamModal }, dispatch);
